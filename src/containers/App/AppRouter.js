...
const routes = [
  ...
  {
    path: 'stationDetail/:projectID/:stationID',
    component: asyncComponent(() => import('../Widgets/stationDetail.js')),
  },
  {
    path: 'projectDetail/:projectID',
    component: asyncComponent(() => import('../Widgets/projectDetail.js')),
  },
  {
    path: 'detail/:objectID',
    component: asyncComponent(() => import('../Ecommerce/algolia/detailProduct.js'))
  },
  {
    path: 'inbox',
